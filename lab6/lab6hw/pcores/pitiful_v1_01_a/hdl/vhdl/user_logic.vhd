...
-- Date:              Fri Nov 04 12:15:28 2016 (by Create and Import Peripheral Wizard)
...
architecture IMP of user_logic is
  ...
  --USER signal declarations added here, as needed for user logic
	...
	signal reload_enable : std_logic;
	signal delay_value : std_logic_vector(C_SLV_DWIDTH-1 downto 0);
  ------------------------------------------
...
begin
  ...
  --USER logic implementation added here
	delay_value <= slv_reg1;
	int_enable <= slv_reg0(1);
	count_enable <= slv_reg0(0);
	reload_enable <= slv_reg0(2);
	...
	count_next <= 	count - 1 when (count_enable='1' and count > 0) else
					unsigned(delay_value) when (count_enable='1' and reload_enable='1' and count = 0) else
					count - 1 when (count_enable='1' and reload_enable='0' and count = 0) else
					count;
