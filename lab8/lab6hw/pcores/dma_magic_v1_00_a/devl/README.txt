...
Peripheral Summary:
  ...
  logical library name                       : dma_magic_v1_00_a
  top name                                   : dma_magic
  version                                    : 1.00.a
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/dma_magic_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/dma_magic_v2_1_0.tcl
