...
uint32_t *screenshotFramePointer;
...
void screen_init() {
	...
	myFrameBuffer.FrameStoreStartAddr[1] = FRAME_BUFFER_0_ADDR + 4*SCREEN_PIXELS_ACROSS*SCREEN_PIXELS_DOWN;
	...
	screenshotFramePointer = ((uint32_t *) FRAME_BUFFER_0_ADDR) + SCREEN_PIXELS_ACROSS*SCREEN_PIXELS_DOWN;

	// This tells the HDMI controller the resolution of your display (there must be a better way to do this).
	XIo_Out32(XPAR_AXI_HDMI_0_BASEADDR, SCREEN_PIXELS_ACROSS*SCREEN_PIXELS_DOWN);
